            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/61d6a2c5-a12b-4468-a817-baf4c926e927" method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    <input type='text' name='email' placeholder='Enter your email' className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'/>
                        <input type='phone' name='mobilenumber' placeholder='Enter your mobile number' className='my-4 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'/>
